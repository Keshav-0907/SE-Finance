  ...
  return (
    <><div className="py-28 px-10">
      ...
      <div className="text-sm py-2">
        Kotak Mahindra Bank offers a range of home loans in India to help
        individuals purchase their dream homes. As a significant investment, we
        understand the importance of making the right decision, which is why we
        provide comprehensive information on home finance, including interest
        rates, eligibility criteria, and customisable loan offerings. Whether
        you are a first-time homebuyer, upgrading to your dream home or planning
        ...
        as home loan calculators and FAQs to guide you towards making an
        informed decision. Take the first step towards owning your dream home in
        India today by applying for housing finance with Kotak. You can apply
        online for a Kotak Home Loan via our website, Mobile Banking App, or by
